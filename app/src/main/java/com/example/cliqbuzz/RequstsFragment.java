 ...
 * Use the {@link RequstsFragment#newInstance} factory method to
...
public class RequstsFragment extends Fragment
{
     ...
     * @return A new instance of fragment RequstsFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static RequstsFragment newInstance(String param1, String param2) {
        RequstsFragment fragment = new RequstsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RequestsFragmentView = inflater.inflate(R.layout.fragment_requsts, container, false);
                                                                                                       ...
                                                                                                       ChatRequestsRef.child(list_user_id).child(currentUserID)
                                                                                                               ...
                                                                                                               .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                                                   ...
                                                                                                                   public void onComplete(@NonNull Task<Void> task)
                                                                                                                   {
                                                                                                                       if (task.isSuccessful())
                                                                                                                       {
                                                                                                                           Toast.makeText(getContext(), "New Contact Created", Toast.LENGTH_SHORT).show();
                                                                                                                       }
                                                                                                                   }
                                                                                                               });
                                                                                                   }
